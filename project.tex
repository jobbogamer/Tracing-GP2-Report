...
\abstract{
The University of York has developed a graph programming language, GP 2, which
has its own IDE. In this project, new features are designed, implemented, and
evaluated which allow users to step through programs in the IDE in order to
reason about them.
}
